...
import { AcrylicBellStage } from '@/components/hero/AcrylicBellStage';
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-6 top-24 rotate-[-8deg] rounded-3xl bg-white/55 px-5 py-3 font-display font-black text-pink shadow-soft">
          Pastel Bell Atelier
        </div>
        <div className="absolute bottom-20 right-8 rotate-6 rounded-3xl bg-peach/50 px-5 py-3 font-black text-mocha shadow-soft">
          soft acrylic stage
        </div>
      </div>
